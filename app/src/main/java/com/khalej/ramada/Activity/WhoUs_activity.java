...
public class WhoUs_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whouse);
        ...
        call.enqueue(new Callback<contact_general_>() {
            ...
            public void onResponse(Call<contact_general_> call, Response<contact_general_> response) {
                contact=response.body();
                 whous.setText(contact.getPayload().getAbout().getAbout_us().toString());
            }
