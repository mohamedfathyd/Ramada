...
public class contact_charge {
    @SerializedName("payload")
    shipments_requests.requests payload;
    ...
    public shipments_requests.requests getPayload() {
        return payload;
    }

    public void setPayload(shipments_requests.requests payload) {
